...
| fossil.commitAll | Commit All |
| fossil.commitBranch | Commit Creating New Branch...
| fossil.commitStaged | Commit Staged
...
| fossil.pull | Pull | | Execute `fossil pull` or `fossil update` depending on `autoUpdate` configuration option
| fossil.push | Push | | 1. Execute `fossil push`<br>2. Deal with errors
| fossil.pushTo | Push to... | <span style="color: darkred">not implemented correctly</span>
...
| fossil.showOutput | Show fossil output |
